...
//let subToken ="91c023159feb950e07c1fde7ab6ba5df95d1b3441d4a4e88d1e534c738f81f8d";//EXAMPLE
 let preVideo = "vides/audiosync.mp4";
  ...
  function setMultiopus(offer){
    ///// currently chrome support will add downmix
    ...
    let isFirefox =  navigator.userAgent.toLowerCase().indexOf('firefox') > -1;//No Sound on FireFox

    //alert("Use Chrome for best sound experience");
    let isChrome = false;
    if (isIOSChrome) {
